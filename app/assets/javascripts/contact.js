...
jQuery(document).ready(function($) {
    ...
    function showInputMessage(message, status, messageContainer) {
        ...
        messageContainer.append('<div class="oxy-margin-top-20 oxy-alert oxy-alert--' + status + '" role="alert"><div class="oxy-alert--text">' + message.message + '</div><div class="oxy-alert--action"><a class="mdl-button mdl-js-button mdl-button--icon"><i class="material-icons">close</i></a></div></div>');
    }
});